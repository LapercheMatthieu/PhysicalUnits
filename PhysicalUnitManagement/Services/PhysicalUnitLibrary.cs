...
using static  PhysicalUnitManagement.Services.PhysicalUnitLibraryFactory;
    ...
    public static class PhysicalUnitLibrary
    {
        ...
        private static void RegisterAllBaseUnits()
        {
            ...
            void Metric(string key, UnitType type, string name, string symbol, decimal factor, params (BaseUnitType, Fraction)[] raw)
                => Reg(key, type, name, symbol, StandardUnitSystem.Metrique, false, factor, 0.0, raw);
            ...
            void Other(string key, UnitType type, string name, string symbol, decimal factor, params (BaseUnitType, Fraction)[] raw)
                => Reg(key, type, name, symbol, StandardUnitSystem.Autre, false, factor, 0.0, raw);

            void Astro(string key, UnitType type, string name, string symbol, decimal factor, params (BaseUnitType, Fraction)[] raw)
                => Reg(key, type, name, symbol, StandardUnitSystem.Astronomique, false, factor, 0.0, raw);
            ...
            WithOffset("Celsius", UnitType.Temperature_Base, "Celsius", "°C", StandardUnitSystem.Metrique, 1m, 273.15, (BaseUnitType.Temperature, Fraction.One));
