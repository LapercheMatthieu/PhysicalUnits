...
namespace MatthL.PhysicalUnits.Infrastructure.Library
{
    ...
    public static class PhysicalUnitLibraryFactory
    {
        ...
        {
            return CreateSimpleUnit(type, name, symbol, StandardUnitSystem.Metric, false, factor, 0.0, Prefix.SI, dimensions);
        }
        ...
        public static PhysicalUnit MetricWithPrefix(UnitType type, string name, string symbol, Prefix prefix, params (BaseUnitType, Fraction)[] dimensions)
        {
            ...
            return CreateSimpleUnit(type, name, symbol, StandardUnitSystem.Metric, false, factor, 0.0, prefix, dimensions);
        }
        ...
        {
            return CreateSimpleUnit(type, name, symbol, StandardUnitSystem.Astronomical, false, factor, 0.0, Prefix.SI, dimensions);
        }
        ...
        {
            return CreateSimpleUnit(type, name, symbol, StandardUnitSystem.Other, false, factor, 0.0, Prefix.SI, dimensions);
        }
        ...
        {
            var system = factor == 1m ? StandardUnitSystem.SI : StandardUnitSystem.Other;
        ...
        {
            return CreateSimpleUnit(type, name, symbol, StandardUnitSystem.Other, false, factor, 0.0, Prefix.SI, (BaseUnitType.Ratio, 1));
        }
        ...
        {
            var system = name.Contains("Dollar") ? StandardUnitSystem.US : StandardUnitSystem.Other;
        ...
        {
            return CreateSimpleUnit(type, name, symbol, StandardUnitSystem.Other, false, factor, 0.0, Prefix.SI, (BaseUnitType.Information, 1));
        }
